...
// Muscle groups most relevant to running performance/recovery — used to
// surface strength readiness on the Running side of the dashboard.
export const RUNNING_MUSCLES = ["quads", "hamstrings", "calves", "glutes", "core"];
